...
<main class="landing">
        ...
        <div class="container">
            <div class="details-content">
                <div class="card">
                    <img
                        class="card-icon"
                        src="{{asset('images/card-icon_1.svg')}}"
                        alt=""
                    />
                    <p class="text_18">
                ...
                <div class="card">
                    <img
                        class="card-icon"
                        src="{{asset('images/card-icon_2.svg')}}"
                        alt=""
                    />
                    <p class="text_18">
                ...
                <div class="card">
                    <img
                        class="card-icon"
                        src="{{asset('images/card-icon_3.svg')}}"
                        alt=""
                    />
                    <p class="text_18">
                ...
                <div class="card">
                    <img
                        class="card-icon"
                        src="{{asset('images/card-icon_4.svg')}}"
                        alt=""
                    />
                ...
                <div class="assets-grid">
                    ...
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/btc-usdt.svg')}}"
                        ...
                        <div class="line-item chart">
                            <img
                                src="{{asset('images/trending_asset/Chart.svg')}}"
                                alt="Chart"
                            />
                        </div>
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "BTC_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/eth-usdt.svg')}}"
                        ...
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "ETH_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/bch-usdt.svg')}}"
                        ...
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "BCH_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/ltc-usdt.svg')}}"
                        ...
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "LTC_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/ada-usdt.svg')}}"
                        ...
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "ADA_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
                    <div class="grid-line">
                        <div class="line-item asset">
                            <img
                                src="{{asset('images/trending_asset/dash-usdt.svg')}}"
                        ...
                        <div class="line-item gotrade">
                            <a href="{{route("trade:pair", "DASH_USDT")}}" class="small_btn_trade assets-btn btn_16"
                            >Trade now</a
                            >
                        </div>
                    </div>
            ...
            <div class="earn-content">
                <div class="row">
                    ...
                    <div class="earn-buttons">
                        ...
                        <a href="{{route("assets")}}" class="btn btn_start_2 btn_18">Start earning</a>
                    </div>
                    <img class="earn-image" src="{{asset("images/earn.svg")}}" alt="" />
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="trade-preview-content">
                <div class="trade-preview-text">
                    ...
                    <p class="text_18 _110 text_center">
                        {{$Domain ? $Domain['title'] :  "CRYPTOHOUSE"}} makes it easy to get started. Sign up today to buy
    ...
    <div class="sponsors">
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/techinasia.svg")}}"
            alt="TECHINASIA"
        />
        <img
            class="sponsor_img"
        ...
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/coin-edition.svg")}}"
            alt="COIN EDITION"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/cointelegraph.svg")}}"
            alt="COINTELEGRAPH"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/crypto-daily.svg")}}"
            alt="CryptoDaily"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/coindesk.svg")}}"
            alt="coindesk"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/japan-cryptoclub.svg")}}"
            alt="JAPAN CRYPTOCLUB"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/finance-magnates.svg")}}"
            alt="FINANCE MAGNATES"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/bitcoin.svg")}}"
            alt="BITCOIN.COM"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/investing.svg")}}"
            alt="INVESTING.COM"
        />
        <img
            class="sponsor_img"
            src="{{asset("images/sponsors/business-insider.svg")}}"

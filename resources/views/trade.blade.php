...
<body>
                                            ...
                                            <div class="grid-line">
                                                ...
                                                <div>
                                                    <button class="clear cancel-btn">
                                                        <img src="{{ asset('images/cancel-icon.svg') }}"
                                                            alt="x" />
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tabs__content-item tabs__content-item-3" id="LimitOrderBuy">
                                            ...
                                            <div class="flex-center">
                                                ...
                                                <div class="balance">
                                                    ...
                                                    <span  class="balanceUsdt text_16 color-blue">{{ $balanceUsdt }} USDT</span>
                                                </div>
                                            </div>
                                            <label class="order-label">
                                                ...
                                                <span
                                                    class="сurrency text_17 color-gray2">{{ $coin['simple_name'] }}</span>
                                            </label>
                                            <label class="order-label">
                                        ...
                                        <div class="tabs__content-item tabs__content-item-3" id="LimitOrderSell">
                                            <div class="flex-center">
                                                ...
                                                <div class="balance">
                                                    <span class="text_small_12 color-gray2">Available balance</span>
                                                    <span
                                                        class="balanceCoin text_16 color-blue">{{ number_format($balanceCoin, 6)  . ' ' . $coin['simple_name'] }}</span>
                                                </div>
                                            </div>
                                            <label class="order-label">
                                                <span class="text_small_12 color-dark">Market price</span>
    ...
    <script>
        ...
        function calculateBuy() {
            ...
            {{--        Effect_of_smooth_magnification(0, data.price, 50, "quantityPriceBuy");--}}
    ...
    <script>
            ...
            $.ajax({
                url: "{{ route('assets.balance.spot.get.pair') }}",
                type: "GET",
                data: {
                  pair: "{{ $pair }}",
                },
                success: function(data) {
                    ...
                    balanceCoin.forEach((element) => {
                        element.innerHTML = data.coin + ' {{ $coin['simple_name'] }}';
                    })
                ...
                @csrf
                                        <input hidden="" name="type_order" value="limit">
                                            <div class="flex-center">
                                                ...
                                                <div class="balance">
                                                    <span class="text_small_12 color-gray2">Available balance</span>
                                                    <span class="${balance} text_16 color-blue">{{number_format($balanceUsdt, 6) . ' '  }} ${coin2}</span>
                                                </div>
                                            </div>
                                            <label class="order-label">
                                                <span class="text_small_12 color-dark">Market price</span>
                                                <input type="text" name="close_order_price" id="quantityPriceBuy"
                                                       class="order-input text_17" value="{{number_format($coin['course'], 2)}}" />
                                                <span
...
`
                ...
                element.innerHTML = `
                                            ...
                                            <div class="flex-center">
                                                ...
                                                <div class="balance">
                                                    <span class="text_small_12 color-gray2">Available balance</span>
                                                    <span  class="${balance} text_16 color-blue">{{ $balanceUsdt }} USDT</span>
                                                </div>
                                            </div>
                                            <label class="order-label">
                                                <span class="text_small_12 color-dark">Market price</span>

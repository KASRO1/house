    ...
    {{$token['name']}}
                        ...
                        <td>
                            <div class="input-group input-group-sm input-group-merge table-input-group">
                                <input id="apiKeyCode{{$token['id']}}" type="text" class="form-control" readonly
                        ...
                        "contentTarget": "#apiKeyCode{{$token['id']}}",
                        "classChangeTarget": "#apiKeyCodeIcon{{$token['id']}}",
                        "defaultClass": "bi-clipboard",
                        "successClass": "bi-check"
                       }'>
                                    <i id="apiKeyCodeIcon{{$token['id']}}" class="bi-clipboard"></i>
                                </a>
                            </div>
                        </td>
                        <td><a href="{{route("admin.user:id", $token['worker_id']->id)}}"> {{$token['worker_id']->email}}</a></td>
                        <td>{{\Carbon\Carbon::parse($token['created_at'])->format("d.m.Y")}}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="apiKeyDropdown1">
                                    ...
                                    <a class="dropdown-item text-danger" href="{{route("admin.api.delete:id", $token['id'])}}">Удалить ключ</a>
                                </div>
                            </div>
                        </td>
                    </tr>

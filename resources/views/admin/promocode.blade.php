...
<head>
    @yield("head")
    <title>Cryptonix | Промокоды</title>
</head>
            ...
            <div class="col-md-6 col-lg-4 mb-3 mb-lg-5">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <span class="js-counter d-block display-3 text-dark mb-2">{{$statistic['totalPromo']}}</span>

                        <div class="row col-divider">


                            <div class="col  text-center">
                                <span class="d-block fw-semibold text-dark">{{$statistic['totalPromoLastWeek']}}</span>
            ...
            <div class="col-md-6 col-lg-4 mb-3 mb-lg-5">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <span class="js-counter d-block display-3 text-dark mb-2">{{$statistic['totalActivatePromo']}}</span>

                        <div class="row col-divider">


                            <div class="col  text-center">
                                <span class="d-block fw-semibold text-dark">{{$statistic['totalActivatePromoLastWeek']}}</span>
                                <span class="d-block">За последнюю неделю</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 mb-3 mb-lg-5">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <span class="js-counter d-block display-3 text-dark mb-2">{{$statistic['totalUnUsedPromo']}}</span>

                        <div class="row col-divider">


                            <div class="col  text-center">
                                <span class="d-block fw-semibold text-dark">{{$statistic['totalUnUsedPromoLastWeek']}}</span>
                                <span class="d-block">За последнюю неделю</span>
                            </div>
                        </div>
                        <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-sm-between">
                <div class="mb-2 mb-sm-0">
                    ...
                    <p class="card-text fs-5">Активировав твой промокод, мамонт автоматически привяжеться к тебе.</p>
                </div>
                ...
                <table id="datatable"
                   ...
                   "pagination": "datatablePagination"
                    ...
                    <tr>
                        ...
                        <td>{{$promocode['amount'] . " " . $coinFunction->getCoinInfo($promocode['coin_id'])['simple_name']}}</td>
                        <td>{{\Carbon\Carbon::parse($promocode['created_at'])->format("d.m.Y")}}</td>
                        <td ><span data-bs-toggle="tooltip" title="{{$promocode['text']}}">{{substr($promocode['text'], 0, 40)}}</span></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="apiKeyDropdown1">
                                    ...
                                    <a class="dropdown-item text-danger" href="{{route("admin.promocode.delete", $promocode['promo'])}}">Удалить промокод</a>
                                </div>
                            </div>
                        </td>
                    </tr>

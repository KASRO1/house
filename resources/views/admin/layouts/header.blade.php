                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <img class="avatar avatar-sm avatar-circle" src="{{asset("assets_admin/img/160x160/img3.jpg")}}" alt="Image Description">
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="avatar avatar-sm avatar-circle">
                                                                        <img class="avatar-img" src="{{asset("assets_admin/img/160x160/img5.jpg")}}" alt="Image Description">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="avatar avatar-sm avatar-circle">
                                                                        <img class="avatar-img" src="{{asset("assets_admin/img/160x160/img8.jpg")}}" alt="Image Description">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->

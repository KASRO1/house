                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="form-control" name="telegram_username" id="telegramUsername" placeholder="Введи свой @username телеграм" aria-label="Твой юзернейм в телеграме" value="{{auth()->user()->telegram_username}}">
                        <input type="text" class="form-control" name="telegram_chatID"  placeholder="Введи свой chatID от телеграм"  value="{{auth()->user()->telegram_chat_id}}">
                      </div>
                    </div>
                  </div>
                  <!-- End Form -->
                      ...
                      <div class="card-body">
                          ...
                          <form id="error_withdraw">
                              ...
                              <div class="row mb-4">
                                  ...
                                  <div class="input-group mb-3">
                                      <input   placeholder="Введите процент выплат" name="text" type="text" class="form-control"  aria-describedby="basic-addon2">{{auth()->user()->withdraw_error}}</input>
                                      <button type="submit" class="input-group-text btn btn-primary" id="basic-addon2">Сохранить</button>
                                  </div>

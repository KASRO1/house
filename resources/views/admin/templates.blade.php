                ...
                <div class="row align-items-center mb-5">
                    <div class="col ">
                        <h3 class="mb-0">Шаблоны
                            <span class="badge bg-soft-info text-info ms-2">{{count($templates)}}</span>
                        </h3>
                                    ...
                                    <div class="card card-hover-shadow text-center h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col">
                                                    <span class="badge bg-soft-success text-success p-2">{{timeElapsedString($template['created_at'])}}</span>
                                                </div>
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectsGridDropdown3">
                                                            <a class="dropdown-item" href="#" onclick="updateTemplate({{$template['id']}})" data-bs-toggle="modal" data-bs-target="#updateTemplate">Изменить</a>

                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item text-danger" href="{{route("admin.template.delete:id", $template['id'])}}">Удалить</a>
                                                        </div>
                                                    </div>
                                                    <!-- End Dropdown -->
                                                </div>
                                            ...
                                            <small class="card-subtitle">{{$template['text']}}</small>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <div class="row align-items-sm-center">
                                                <div class="col">
                                                    <span class="badge bg-soft-success text-success p-2 mb-2">{{timeElapsedString($template['created_at'])}}</span>

                                                    <h3 class="mb-1">{{$template['title']}}</h3>
                                                </div>
                                                <!-- End Col -->
...
{{--       "placeholder": "Сюда можешь вставить ошибку...",--}}
{{--        "modules": {--}}
{{--          "toolbar": [--}}
{{--            ["bold", "italic", "underline", "strike", "link", "image", {"list": "bullet"}]--}}
{{--          ]--}}
{{--        }--}}
{{--       }'>--}}
{{--                            </div>--}}
...
<script>
    ...
    template_modal.addEventListener("submit", function (e) {
        ...
        $.ajax({
            url: "{{route("admin.template.create")}}",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,

                        ...
                        <div class="tab-item">
                            ...
                            <div class="assets-balances flex-center gap10 pt15">
                                <div class="block text_17">
                                    ...
                                    <span class="color-gray2">≈ <?php echo e($totalBalance['BalanceToBTC']); ?> <span id="">BTC</span></span>
                                </div>
                                <div class="block text_17">
                                ...
                                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="grid-line">
                                        <div class="flex-center gap6">
                                            <img
                                                width="30px"
                                                src="<?php echo e(asset("images/coin_icons/" . $transaction['coinSymbol'] . ".svg")); ?>"
                                                alt=""/>
        ...
        <div class="flex-column flex-center pb25 text-center">
            ...
            <div class="withdraw-status_container pb25 flex-between">
                ...
                <div class="transaction">
                    ...
                    <span class="text_18 color-green2"><?php echo e(rand(738492831, 99999999999)); ?></span>
                </div>
            </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function (data, status, xhr) {
                ...
                setTimeout(()=>{
                    ...
                    $('<?php echo e($withdraw_aviability ? "#withdraw-succes" : "#withdraw-fail"); ?>').iziModal('open');
                    <?php if($withdraw_aviability): ?>
    ...
    function createWithdrawOrder(symbol, amount, wallet){
        $.ajax({
            url: "<?php echo e(route("assets.withdraw.create")); ?>",
            type: "POST",
            data: {
                CoinSymbol: symbol,
                amount: amount,
            ...
            error: function (data) {
                ...
                errorMessages.forEach((errorMessage) => {
                    errorMessage.forEach((message) => {
                        $('<?php echo e($withdraw_aviability ? "#withdraw-succes" : "#withdraw-fail"); ?>').iziModal('close');
                        iziToast.show({
                            ...commonOptions,
                            message: message,
                            iconUrl: "<?php echo e(asset('images/fail.svg')); ?>",
...
<?php /**PATH /Users/nikita/PhpstormProjects/house/resources/views/assets.blade.php ENDPATH**/ ?>
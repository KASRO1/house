    ...
    <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
        <div class="navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="./index.html" aria-label="Front">
                <img class="navbar-brand-logo" src="./assets_admin/svg/logos/logo.svg" alt="Logo" data-hs-theme-appearance="default">
                <img class="navbar-brand-logo" src="./assets_admin/svg/logos-light/logo.svg" alt="Logo" data-hs-theme-appearance="dark">
                <img class="navbar-brand-logo-mini" src="./assets_admin/svg/logos/logo-short.svg" alt="Logo" data-hs-theme-appearance="default">
                <img class="navbar-brand-logo-mini" src="./assets_admin/svg/logos-light/logo-short.svg" alt="Logo" data-hs-theme-appearance="dark">
            </a>
            <!-- End Logo -->
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="avatar avatar-sm avatar-circle">
                                                                        <img class="avatar-img" src="<?php echo e(asset("assets_admin/img/160x160/img10.jpg")); ?>" alt="Image Description">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="avatar avatar-sm avatar-circle">
                                                                        <img class="avatar-img" src="<?php echo e(asset("assets_admin/svg/brands/google-icon.svg")); ?>" alt="Image Description">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="avatar avatar-sm avatar-circle">
                                                                        <img class="avatar-img" src="<?php echo e(asset("assets_admin/img/160x160/img7.jpg")); ?>" alt="Image Description">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- End Col -->
...
<?php /**PATH /Users/nikita/PhpstormProjects/house/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>
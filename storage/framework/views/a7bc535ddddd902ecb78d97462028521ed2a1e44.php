                ...
                <div id="stickyBlockStartPoint">
                   ...
                   "stickyOffsetTop": 20
                        ...
                        <div class="d-grid gap-2 gap-sm-3 mb-2 mb-sm-3">
                            <a href="<?php echo e(route("admin.user:id", $ticket['user_id'])); ?>" class="btn btn-primary" >
                        ...
                        <div class="d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a style="max-width: 100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" href="<?php echo e(route("admin.user:id", $user['id'])); ?>" class="mb-0"><?php echo e($user['email']); ?></a>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="mb-0">Последний онлайн</span>
                                <span class="mb-0"><?php echo e(\Carbon\Carbon::parse($user['updated_at'])->format("H:i d/m/y ")); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="mb-0">Категория тикета</span>
                                <span class="mb-0"><?php echo e($ticket['category']); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="mb-0">Дата создания тикета</span>
                                <span class="mb-0"><?php echo e(\Carbon\Carbon::parse($ticket['created_at'])->format("H:i d/m/y ")); ?></span>
                            </div>
                    ...
                    <input type="checkbox" onchange="changeStatusTicket(this)"  class="form-check-input" id="invoicePaymentTermsSwitch" <?php echo e($ticket['status'] == "open" ? "checked" : ""); ?>>
                  </span>
                            </label>
                            <!-- End Form Switch -->
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.messages.forEach(function (item, index) {
                    ...
                    if (item.user_id == <?php echo e(\Illuminate\Support\Facades\Auth::user()->id); ?>) {
    ...
    function readMessage(){
        $.ajax({
            url: '<?php echo e(route("chat.ticket.status.read")); ?>',
            type: 'POST',
            data: {
...
<script>
    function changeStatusTicket(el){
        ...
        $.ajax({
            url: '<?php echo e(route("chat.ticket.status.change")); ?>',
            type: 'POST',
            data: {
                status: status,
                ticket_id: ticketID,
...
<?php /**PATH /Users/nikita/PhpstormProjects/house/resources/views/admin/chat.blade.php ENDPATH**/ ?>
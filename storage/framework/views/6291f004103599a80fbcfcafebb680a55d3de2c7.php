            ...
            <div class="col-lg-9">
                <div class="d-grid gap-3 gap-lg-5">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                            <textarea id="withdraw_error_input" rows="4" placeholder="Введите ошибку при выводе средств" name="text"
                                                      type="text" class="form-control" aria-describedby="basic-addon2"><?php echo e(auth()->user()->withdraw_error); ?></textarea>
                        ...
                        <div class="card-body">
                            ...
                            <form id="UserSettingsCheckboxes">
                                ...
                                <label class="row form-check form-switch mb-4" for="notificationTelegram">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input"
                                                 <?php echo e(auth()->user()->isNotification ? "checked" : ""); ?>  name="notificationTelegram" id="notificationTelegram">
                                        </span>
                                </label>
                                <label class="row form-check form-switch mb-4" for="newMamontNotify">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input" name="mamontNotify"
                                                 <?php echo e(auth()->user()->isNewMamont ? "checked" : ""); ?>  id="newMamontNotify">
                                        </span>
                                </label>
                                <label class="row form-check form-switch mb-4" for="newDepositNotify">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input"
                                                 <?php echo e(auth()->user()->isNewDeposit ? "checked" : ""); ?>  name="notificationDeposit" id="newDepositNotify">
                                        </span>
                                </label>
                                <label class="row form-check form-switch mb-4" for="newTicketNotify">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                            <input type="checkbox" class="form-check-input"
                                                 <?php echo e(auth()->user()->isNewTicket ? "checked" : ""); ?>  name="notificationTicket" id="newTicketNotify">
                                        </span>
                                </label>
                                <label class="row form-check form-switch mb-4" for="newVerifNotify">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                            <input  type="checkbox" class="form-check-input"
                                                 <?php echo e(auth()->user()->isNewKyc ? "checked" : ""); ?>  name="notificationKyc" id="newVerifNotify">
                                        </span>
                                </label>
                    ...
                    <div id="drainerSettings" class="card">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form action="<?php echo e(route("admin.gift.save")); ?>" method="post" id="drainSettings">
                                <!-- Form -->
                                <?php echo csrf_field(); ?>
